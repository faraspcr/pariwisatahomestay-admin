...
<head>
    ...
    <title>Edit Warga - Sistem Administrasi</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-4 py-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2>Edit Warga</h2>
                        <p class="mb-0 text-muted">Form untuk mengedit data warga</p>
                    </div>
                    <div class="dropdown">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('no_ktp') is-invalid @enderror"
                                               id="no_ktp" name="no_ktp" value="{{ $dataWarga->no_ktp }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                               id="nama" name="nama" value="{{ $dataWarga->nama }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror"
                                               id="pekerjaan" name="pekerjaan" value="{{ $dataWarga->pekerjaan }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('telp') is-invalid @enderror"
                                               id="telp" name="telp" value="{{ $dataWarga->telp }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                               id="email" name="email" value="{{ $dataWarga->email }}"
