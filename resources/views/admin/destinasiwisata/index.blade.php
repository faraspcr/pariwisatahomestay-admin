                        ...
                        <div class="card-body">
                                        ...
                                        <tr class="destination-card">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="mr-3">
                                                        <i class="mdi mdi-map-marker-circle text-success" style="font-size: 24px;"></i>
                                                    </div>
                                                    <div>
                                                        <div class="font-weight-bold text-success">{{ $item->nama }}</div>
                                                        <small class="text-muted">ID: {{ $item->destinasi_id }}</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="text-truncate" style="max-width: 150px;">{{ $item->alamat }}</span>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <span class="badge badge-time py-2 px-3">
                                                    <i class="mdi mdi-clock-outline mr-1"></i>{{ $item->jam_buka }}
                                                </span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge badge-price py-2 px-3">
                                                    <i class="mdi mdi-ticket mr-1"></i>Rp {{ number_format($item->tiket, 0, ',', '.') }}
                                                </span>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                            ...
                                            <td class="text-center action-buttons">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <form action="{{ route('destinasiwisata.destroy', $item->destinasi_id) }}" method="POST" style="display:inline">
                                                        @csrf
                                                        @method("DELETE")
                                                        <button type="submit"
                                        ...
                                        <tr>
                                            <td colspan="9" class="text-center py-5">
                                                <div class="d-flex flex-column align-items-center">
                                                    <i class="mdi mdi-map-marker-off text-muted" style="font-size: 64px;"></i>
                                                    <h4 class="text-muted mt-3">Belum ada data destinasi wisata</h4>
                                                    <p class="text-muted">Silakan tambah destinasi wisata terlebih dahulu</p>
                                                    <a href="{{ route('destinasiwisata.create') }}" class="btn btn-success mt-2">
                                                        <i class="mdi mdi-plus-circle-outline mr-1"></i>Tambah Destinasi Pertama
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <div class="text-muted">
                                    Menampilkan {{ $destinasiWisata->firstItem() }} - {{ $destinasiWisata->lastItem() }} dari {{ $destinasiWisata->total() }} destinasi
                                </div>
                                <nav>
                                ...
                                <div class="col-md-12">
                                    <div class="alert alert-success">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="alert-heading mb-1">Total Destinasi Wisata: {{ $destinasiWisata->count() }}</h6>
                                                <p class="mb-0">Destinasi wisata yang terdaftar dalam sistem Bina Desa</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
