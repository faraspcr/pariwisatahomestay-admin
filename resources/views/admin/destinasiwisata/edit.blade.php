...
<head>
    ...
    <title>Edit Destinasi Wisata - Bina Desa</title>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('destinasiwisata.index') }}">Destinasi
                                        Wisata</a></li>
                    ...
                    <div class="card form-container">
                        <div class="card-body">
                            <form action="{{ route('destinasiwisata.update', $destinasi->destinasi_id) }}"
                                method="POST" id="destinasiForm">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <!-- Nama Destinasi -->
                                        <div class="mb-3">
                                            <label for="nama" class="form-label">Nama Destinasi <span
                                                    class="required-star">*</span></label>
                                            <input type="text"
                                                class="form-control @error('nama') field-error @enderror"
                                                id="nama" name="nama"
                                        ...
                                        <div class="mb-3">
                                            <label for="deskripsi" class="form-label">Deskripsi <span
                                                    class="required-star">*</span></label>
                                            <textarea class="form-control @error('deskripsi') field-error @enderror" id="deskripsi" name="deskripsi"
                                        ...
                                        <div class="mb-3">
                                            <label for="alamat" class="form-label">Alamat Lengkap <span
                                                    class="required-star">*</span></label>
                                            <textarea class="form-control @error('alamat') field-error @enderror" id="alamat" name="alamat" rows="3"
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="rt" class="form-label">RT <span
                                                            class="required-star">*</span></label>
                                                    <input type="text"
                                                        class="form-control @error('rt') field-error @enderror"
                                                        id="rt" name="rt"
                                                        value="{{ old('rt', $destinasi->rt) }}" placeholder="001"
                                                        maxlength="3">
                                                    @error('rt')
                                                        <div class="error-message">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="rw" class="form-label">RW <span
                                                            class="required-star">*</span></label>
                                                    <input type="text"
                                                        class="form-control @error('rw') field-error @enderror"
                                                        id="rw" name="rw"
                                                        value="{{ old('rw', $destinasi->rw) }}" placeholder="002"
                                                        maxlength="3">
                                                    @error('rw')
                                                        <div class="error-message">{{ $message }}</div>
                                                    @enderror
                                        ...
                                        <div class="mb-3">
                                            <label for="jam_buka" class="form-label">Jam Buka <span
                                                    class="required-star">*</span></label>
                                            <input type="time"
                                                class="form-control @error('jam_buka') field-error @enderror"
                                        ...
                                        <!-- Tiket -->
                                        <div class="mb-3">
                                            <label for="tiket" class="form-label">Harga Tiket (Rp) <span
                                                    class="required-star">*</span></label>
                                            <input type="number"
                                                class="form-control @error('tiket') field-error @enderror"
                                                id="tiket" name="tiket"
                                        ...
                                        <div class="mb-3">
                                            <label for="kontak" class="form-label">Kontak <span
                                                    class="required-star">*</span></label>
                                            <input type="text"
                                                class="form-control @error('kontak') field-error @enderror"
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <div class="d-flex justify-content-end gap-2">
                                            <a href="{{ route('destinasiwisata.index') }}"
