...
class PariwisataDestinasiAdminController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Jika tidak ada session username, redirect ke login
        if (!$username) {
            return redirect('/auth')->withErrors(['login' => 'Silakan login terlebih dahulu!']);
        }
        ...
        return view('pariwisatadestinasi_admin', compact('destinasi', 'username'));
    }
